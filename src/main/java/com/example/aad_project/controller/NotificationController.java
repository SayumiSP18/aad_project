...
public class NotificationController {
    ...
    public CommonResponse saveNotification(@Valid @RequestBody NotificationDTO notificationDTO) {
    ...
    public CommonResponse updateNotification(@Valid @RequestBody NotificationDTO notificationDTO) {
